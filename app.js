...
function kanriClear() {
  ...
  document.querySelectorAll('.kanri-file-name').forEach(function(el) { el.textContent = ''; });
  document.querySelectorAll('.kanri-file-input, .kanri-drop input[type=file]').forEach(function(el) { el.value = ''; });
  var log = document.getElementById('kanri-log');
